...
export default function Contact() {
    ...
    return (
        <>
            ...
            <div class="contact-section section-padding" style={{ marginTop: "50px" }}>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <div class="contact-form contact-form-3">
                                ...
                                <form id="contact-form" class="form" novalidate="novalidate" onSubmit={onSubmit}>
                                    <div class="row">
