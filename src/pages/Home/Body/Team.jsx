...
export default function team() {
    const team = [
        ...
        },
        {
            ...
            image: "/static/images/team/b720ef96dbf67eea7116f21694740a5d.jpg",
            title: "Erdenebaatar.N",
            text: "Post production manager"
        },
        {
            "source": {
                "id": "engadget",
        ...
        },
        {
            ...
            image: "/static/images/team/b43aad248eed50f46edf4a49ec631dd4.jpg",
            title: "Luvsandagva.B",
            text: "Supervisor"
        },
        {
    ...
    return (
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="title-decoration-lines-left-red">Our Teams</h2>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="testimonial-slider owl-carousel owl-theme owl-loaded owl-drag">
                        <div class="owl-stage-outer"><div class="owl-stage" style={{transform: "translate3d(-5644px, 0px, 0px)", transition: "all 1s ease 0s", width: "11994px"}}>
